...
@section('title', 'Buat Admin Baru - E-Learning Cakrawala')
...
@section('container')
    <div class="flex-column container vh100" id="container">
        <div class="flex-row container-row">
            <form action="{{route('adminCreate')}}" method="POST" class="flex-column container-form">
                @csrf
                <div class="flex-column form-title">
                    <h3 class="poppins">Buat Admin Baru</h3>
                    <p class="montserrat">Isilah dengan teliti pada data-data pembuatan akun admin di bawah ini!</p>
                </div>
                @if ($errors->any())
                ...
                <div class="formel small-btn-submit">
                    <button type="submit" class="poppins">Buat Admin</button>
                </div>
            </form>
